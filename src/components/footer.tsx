...
const footerLinks = {
  platform: {
    ...
    links: [
      ...
      { href: "/matching", label: "Quiz AI Matching" },
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-4 text-sm text-muted-foreground leading-relaxed">
              Platforma digitală care conectează clienții cu psihologi, coachi și
              mentori verificați din România.
            </p>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t pt-8 sm:flex-row">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} Zento. Toate drepturile
            rezervate.
          </p>
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            <span className="inline-block h-2 w-2 rounded-full bg-emerald-500" />
            Linie de criză: <strong>0800 801 200</strong> (gratuit, 24/7)
          </div>
        </div>
      </div>
    </footer>
