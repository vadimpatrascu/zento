...
export default function RegisterPage() {
  ...
  return (
    <>
      ...
      <div>
        <h1 className="text-2xl font-bold tracking-tight">Creează un cont</h1>
        <p className="mt-2 text-muted-foreground">
          Alătură-te platformei Zento gratuit.
        </p>
      </div>
        ...
        <CardContent className="p-6">
          ...
          <Tabs defaultValue="client" className="mb-6">
            <TabsList className="w-full">
              ...
              <TabsTrigger value="specialist" className="flex-1 gap-2">
                <Users className="h-4 w-4" /> Specialist
              </TabsTrigger>
            </TabsList>
            <TabsContent value="client">
              <p className="text-sm text-muted-foreground">
                Caută și programează ședințe cu psihologi, coachi sau mentori.
              </p>
            </TabsContent>
            <TabsContent value="specialist">
              <p className="text-sm text-muted-foreground">
                Creează un profil, gestionează clienți și crește-ți practica.
              </p>
            </TabsContent>
          </Tabs>
          ...
          >
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input id="firstName" required placeholder="Prenumele tău" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="lastName">Nume</Label>
                <Input id="lastName" required placeholder="Numele tău" />
              </div>
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="password" type="password" required placeholder="Minim 8 caractere" />
            </div>
      ...
      <p className="mt-6 text-center text-sm text-muted-foreground">
        Ai deja cont?{" "}
        <Link href="/autentificare" className="font-medium text-primary hover:underline">
          Autentifică-te
        </Link>
      </p>
    </>
